    ...
    public class Transaksi
    {
        ...
        public static List<Transaksi> BacaData(string kriteria, string nilaiKriteria)
        {
            ...
            if (kriteria == "")
            {
                ...
                sql = "select ta.no_rekening,t.transaksi_id, t.tgl_transaksi, jt.id_jenis_transaksi, t.no_rekening, jt.nominal, t.keterangan transaksi t inner join tabungan ta on t.rekening_sumber = ta.no_rekening left join jenisTransaksi jt on t.id_jenis_transaksi = jt.id_jenis_transaksi";

            }
            else
            {
                sql = "select ta.no_rekening,t.transaksi_id, t.tgl_transaksi, jt.id_jenis_transaksi, t.no_rekening, jt.nominal, t.keterangan transaksi t inner join tabungan ta on t.rekening_sumber = ta.no_rekening left join jenisTransaksi jt on t.id_jenis_transaksi = jt.id_jenis_transaksi where " +kriteria + " like '%" + nilaiKriteria+"%'";
